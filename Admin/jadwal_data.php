...
<table width="650" border="1" cellpadding="0" cellspacing="0" bgcolor="#3e9fdd">
  <tr>
    ...
    <th width="40%" align="left" scope="col">ID Trayek</th>
	  <th width="40%" align="left" scope="col">ID Jam</th>
...
$search = $_POST['schtxt']; 
$query = "select * from jadwal where id_jadwal LIKE '%$search%' OR id_trayek LIKE '%$search%' OR id_jam LIKE '%$search%'";
$hasil = mysql_query($query);
while ($data = mysql_fetch_array($hasil))
{
echo '<tr>
<td align="left" width="10%" bgcolor="#FFFFFF">'.$data['id_jadwal'].'</td>
<td align="left" width="40%" bgcolor="#FFFFFF">'.$data['id_trayek'].'</td>
<td align="left" width="40%" bgcolor="#FFFFFF">'.$data['id_jam'].'</td>
<td align="center" width="10%" bgcolor="#FFFFFF">
<a href="jadwal_ubah.php?id_jadwal='.$data[id_jadwal].'"><img width="15" src="../gambar/Ubah.png" height="15" border="0" valign="middle"></a>
&nbsp;
&nbsp;
<a href="jadwal_hapus.php?id_jadwal='.$data[id_jadwal].'" class="confirm" pesan="Anda yakin akan menghapus data tersebut ?"><img width="15" src="../gambar/Hapus.png" height="15" border="0" valign="middle"></a></td>
</tr>';
