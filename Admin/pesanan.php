...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="650" valign="top">
		...
		<tr>
			<td colspan="2" class="juduladmin"><span class="juduladmin">Pesanan</span><hr color="black"/></td>
        </tr>
		<tr>
			<td colspan="2"><?php include "pesanan_form.php"; ?></td>
    </tr>
		<tr>
			<td colspan="2"><?php include "pesanan_data.php"; ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
