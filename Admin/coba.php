...
if ($data==""){
	...
	$hasil = mysql_query($query);
	while ($search = mysql_fetch_array($hasil))
	{
	echo "<tr>
	<td align=\"left\" width=\"5%\" bgcolor=\"#FFFFFF\">".$search['id_member']."</td>
	<td align=\"left\" width=\"10%\" bgcolor=\"#FFFFFF\">".$search['nama']."</td>
	<td align=\"left\" width=\"10%\" bgcolor=\"#FFFFFF\">".$search['alamat']."</td>
	<td align=\"left\" width=\"7%\" bgcolor=\"#FFFFFF\">".$search['telepon']."</td>
	<td align=\"left\" width=\"7%\" bgcolor=\"#FFFFFF\">".$search['email']."</td>
	<td align=\"left\" width=\"7%\" bgcolor=\"#FFFFFF\">".$search['username']."</td>
	<td align=\"left\" width=\"7%\" bgcolor=\"#FFFFFF\">".$search['password']."</td>
	<td align=\"center\" width=\"7%\" bgcolor=\"#FFFFFF\">
	<a href=\"member_ubah.php?id_member=$search[id_member]\"><img width=\"15\" src=\"../gambar/Ubah.png\" height=\"15\" border=\"0\" valign=\"middle\"></a>
	&nbsp;
	&nbsp;
	<a href=\"member_hapus.php?id_member=$search[id_member]\"><img width=\"15\" src=\"../gambar/Hapus.png\" height=\"15\" border=\"0\" valign=\"middle\"></a></td>
	</tr>";
