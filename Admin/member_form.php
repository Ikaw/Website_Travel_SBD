  ...
  <table width="650" border="0" align="left">
    <tr>
      ...
      <td width="69%" align="left" valign="top"><label>
        <input name="namatxt" type="text" id="namatxt" size="40" />
      </label>
        </span></td>
    </tr>
    <tr>
