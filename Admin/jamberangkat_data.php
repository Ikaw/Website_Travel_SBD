...
<table width="680" border="1" cellpadding="0" cellspacing="0" bgcolor="#3e9fdd">
  <tr>
    ...
    <th width="85%" align="left" scope="col">Jam Berangkat</th>
...
$search = $_POST['schtxt']; 
$query = "select * from jamberangkat where id_jam LIKE '%$search%' OR jam LIKE '%$search%'";
$hasil = mysql_query($query);
while ($data = mysql_fetch_array($hasil))
{
echo '<tr>
<td align="left" width="5%" bgcolor="#FFFFFF">'.$data['id_jam'].'</td>
<td align="left" width="85%" bgcolor="#FFFFFF">'.$data['jam'].'</td>
<td align="center" width="10%" bgcolor="#FFFFFF">
<a href="jamberangkat_ubah.php?id_jam='.$data[id_jam].'"><img width="15" src="../gambar/Ubah.png" height="15" border="0" valign="middle"></a>
&nbsp;
&nbsp;
<a href="jamberangkat_hapus.php?id_jam='.$data[id_jam].'" class="confirm" pesan="Anda yakin akan menghapus data tersebut ?"><img width="15" src="../gambar/Hapus.png" height="15" border="0" valign="middle"></a></td>
</tr>';
