  ...
  <tr>
    <td width="150" align="left" valign="top"><div class="Menu_Kiri">
      <ul>
        ...
        <li><a href="trayek.php">Trayek</a></li>
        <li><a href="jamberangkat.php">Jam Berangkat</a></li>
        <li><a href="jadwal.php">Jadwal</a></li>
        <li><a href="pesanan.php">Pesanan</a></li>
		<li><a href="detailpesanan.php">Detail Pesanan</a></li>
        <li><a href="logout.php">Logout</a></li>
      </ul>
    </div></td>
    <td width="650" align="center" valign="top"><div class="Menu_Tengah"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" scope="col"><?php include "jamberangkat_ubah_form.php" ?></td>
  </tr>
  <tr>
