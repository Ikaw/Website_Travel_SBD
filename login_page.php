...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    <td height="40" align="right">
      <a href="login.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('btnlogin','','../webtravel/gambar/btnlogin2.png',1)"><img src="../webtravel/gambar/btnlogin.png" width="120" height="40" id="btnlogin"/></a>
	...
	<tr><td>
      ...
      <tr>
        <td valign="top"><?php include "login_form.php" ?>
        </td>
      </tr>
		</table>
	</td>
